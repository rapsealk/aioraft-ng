...
_CLIENTREQUESTMESSAGE = DESCRIPTOR.message_types_by_name["ClientRequestMessage"]
_CLIENTRESPONSEMESSAGE = DESCRIPTOR.message_types_by_name["ClientResponseMessage"]
...
ClientRequestMessage = _reflection.GeneratedProtocolMessageType(
    "ClientRequestMessage",
    (_message.Message,),
    {
        "DESCRIPTOR": _CLIENTREQUESTMESSAGE,
        "__module__": "raft_pb2"
        # @@protoc_insertion_point(class_scope:ClientRequestMessage)
    },
)
_sym_db.RegisterMessage(ClientRequestMessage)

ClientResponseMessage = _reflection.GeneratedProtocolMessageType(
    "ClientResponseMessage",
    (_message.Message,),
    {
        "DESCRIPTOR": _CLIENTRESPONSEMESSAGE,
        "__module__": "raft_pb2"
        # @@protoc_insertion_point(class_scope:ClientResponseMessage)
    },
)
_sym_db.RegisterMessage(ClientResponseMessage)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CLIENTREQUESTMESSAGE._serialized_start = 438
    _CLIENTREQUESTMESSAGE._serialized_end = 477
    _CLIENTRESPONSEMESSAGE._serialized_start = 479
    _CLIENTRESPONSEMESSAGE._serialized_end = 571
